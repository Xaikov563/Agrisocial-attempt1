...
from . import views
from .views import edit_profile, create_post, like_post, comment_view, reshare_post, delete_product, edit_product, chat_list, chat_detail, send_message, fetch_messages
